...
/* Hide only Streamlit deploy button & hamburger menu (Preserve sidebar toggle controls) */
...
/* Sidebar Radio Buttons (Modern Full-Width Nav Cards, No Clunky Radio Circles) */
...
/* Hide BaseWeb custom radio dot/circle container */
...
[data-testid="stSidebar"] .stRadio div[role="radiogroup"] > label svg,
...
/* Equal Hospital Card Action Buttons */
...
.mm-stepper .mm-step-arrow { color: #475569 !important; }
...
.mm-card {
    ...
    background-color: #111827 !important;
    border: 1px solid #1E293B !important;
    box-shadow: 0 4px 20px rgba(0,0,0,0.45), 0 0 0 1px rgba(225,29,72,0.10) !important;
}
.mm-card:hover {
...
/* -- 9. Text Inputs & TextAreas -- */
/* -- 9. Text Inputs & TextAreas -- */
.stTextInput input,
.stTextArea textarea,
.stTextInput > div > div > input,
.stTextArea > div > div > textarea,
[data-baseweb="base-input"] input:not([data-baseweb="select"] input),
...
.stTextInput [data-baseweb="form-control"],
.stTextArea [data-baseweb="form-control"] {
    background-color: #1E293B !important;
    border: 1.5px solid #334155 !important;
    border-radius: 8px !important;
}
...
.stTextArea [data-baseweb="base-input"]:focus-within {
    ...
    box-shadow: 0 0 0 2px rgba(179,38,30,0.25) !important;
    outline: none !important;
}

/* -- 10. Selectbox & MultiSelect Input Box (CLEAN SINGLE BORDER) -- */
/* Outer containers must be completely transparent with no border */
.stSelectbox,
.stMultiSelect,
[data-baseweb="select"],
.stSelectbox > div,
...
/* ONLY the direct control box gets the clean dark border and background */
...
/* All nested inner elements and search inputs inside select MUST NOT have borders or background */
[data-baseweb="select"] div,
...
/* Text & Placeholder inside Select / MultiSelect */
[data-baseweb="select"] input {
    color: #F8FAFC !important;
...
/* -- 11. Dropdown Popover Menus (Floating List when Opened) -- */
...
/* Hovered / Active / Selected Option in Dropdown */
...
/* -- 13. Symptom Chip Buttons (Popular Symptoms) -- */
...
/* Describe in your own words / Quick Action Buttons */
.st-key-btn_describe_words button,
.st-key-qa_upload_presc button,
.st-key-qa_find_hosp button,
.st-key-qa_health_tips button {
...
/* -- 14. Floating Chat Drawer Dark Mode -- */
div.st-key-slide_chat_drawer,
.st-key-slide_chat_drawer {
    background: #0A0E1A !important;
    background-color: #0A0E1A !important;
    border-left: 1.5px solid rgba(225,29,72,0.3) !important;
    color: #F8FAFC !important;
}
...
.st-key-drawer_close_x_btn button:hover {
    background: rgba(179,38,30,0.35) !important;
    border-color: #F87171 !important;
}

/* -- 15. Header Language Dropdown (Pill Shape) -- */
div[class*="st-key-hdr_lang_"] [data-baseweb="select"],
div[class*="st-key-hdr_lang_"] [data-baseweb="select"] > div:first-child {
    box-shadow: none !important;
}
div[class*="st-key-hdr_lang_"] [data-baseweb="select"] {
    background: transparent !important;
...
/* Hide radio circles in dark mode sidebar */
[data-testid="stSidebar"] [data-testid="stSidebarUserContent"],
[data-testid="stSidebar"] [data-testid="stVerticalBlock"],
[data-testid="stSidebar"] [data-testid="element-container"],
[data-testid="stSidebar"] [data-testid="stRadio"],
...
/* -- 18. Expanders, Metrics & Uploaders -- */
[data-testid="stMetric"] {
    background: #111827 !important;
    border-color: #1E293B !important;
}
...
h1, h2, h3, h4, h5, h6, b, strong, .mm-card-title, .mm-step-text-title {
    color: #F8FAFC !important;
}
p, span, div {
    color: #CBD5E1 !important;
...
/* -- 4. Top Header Cards (All 5 Panels) -- */
div[class*="st-key-mm_top_header_card"] {
    background: #111827 !important;
    background-color: #111827 !important;
...
div[class*="st-key-mm_top_header_card"] .mm-badge-brand {
    background: #2D1215 !important;
    color: #F87171 !important;
    border: 1px solid #4A1A1E !important;
    border-radius: 9999px !important;
}
...
/* -- 6. Form Inputs & Textboxes (No White Borders, Crisp Dark Style) -- */
input,
textarea,
[data-baseweb="input"],
...
/* -- 8. Floating Chatbot Modal & Prompt Chips -- */
...
/* Suggestion Chip Buttons in Chatbot (Pill styling in dark mode) */
...
/* Header Clear & Close Buttons in Chatbot */
div[class*="st-key-drawer_clear_chat_btn"] button,
div[class*="st-key-drawer_close_x_btn"] button {
    background-color: #1E293B !important;
    background: #1E293B !important;
...
/* Cards, Stepper, Containers & Header in Dark Mode */
.mm-card,
.mm-header-bar,
.mm-stepper,
.mm-hospital-card,
...
.mm-step-num.active {
    ...
    border-color: #B3261E !important;
    color: #FFFFFF !important;
    box-shadow: 0 0 14px rgba(179, 38, 30, 0.6) !important;
}
